...
<?php include('menu.html') ?>
	...
	<div class="allcontent2">
		...
		<div class="snippetbox">
			...
			<div class= "snippettextbox">
				<p class="snippettext">I conducted a project with Bloomberg where I worked with a multidisciplinary team of six in order to productize and improve <span class="green">sarcasm detection</span>. We focused on iTunes app ratings and acheived an F1 score of 70%.<br/><br/> Work was done in <span class="blue">python</span> and <span class="blue">javascript</span>.</p>
			</div>
		</div>
	</div>	
</body>
